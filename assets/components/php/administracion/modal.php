            ...
            <div class="modal-body">
                <div class="table-responsive-xl">
                    <table class="table table-sm table-hover table-condensed table-bordered table-striped">
                        ...
                        <?php
                        $sql = "SELECT id_adminRegistros, usuario, accion, producto, nota, DATE_FORMAT(fecha, '%d/%m/%Y ' ' %h:%i:%s') 
                        FROM adminRegistros WHERE accion = 'Modificado' AND usuario = '$usuario' ORDER BY fecha DESC";
            ...
            <div class="modal-body">
                <div class="table-responsive-xl mt-2">
                    <table class="table table-sm table-hover table-condensed table-bordered table-striped">
                        ...
                        <?php
                        $sql = "SELECT id_adminRegistros, usuario, accion, producto, nota, DATE_FORMAT(fecha, '%d/%m/%Y ' ' %h:%i:%s') 
                        FROM adminRegistros WHERE accion = 'Eliminado' AND usuario = '$usuario' ORDER BY fecha DESC";
                        $resultado = mysqli_query($conexion, $sql);
            ...
            <div class="modal-body">
                <div class="table-responsive-xl mt-2">
                    <table class="table table-sm table-hover table-condensed table-bordered table-striped">
                        ...
                        <?php
                        $sql = "SELECT id_adminRegistros, usuario, accion, producto, nota, DATE_FORMAT(fecha, '%d/%m/%Y ' ' %h:%i:%s') 
                        FROM adminRegistros WHERE accion = 'Agregado' AND usuario = '$usuario' ORDER BY fecha DESC";
                        $resultado = mysqli_query($conexion, $sql);
